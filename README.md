...
<<<<<<< HEAD
# Weather-App-React
Um aplicativo simples de consulta de clima feito em React usando Typescript
>>>>>>> cfd84f5 (add: initial files)
...
=======
A aplicação se encontra em inglês por fim de universalidade
=======
